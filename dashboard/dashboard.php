    ...
    <div class="home-content">
        <div class="overview-boxes">
            <div class="box">
                <div class="right-side">
                    <div class="box-topic">Numarul turistilor</div>
                    <div class="number">40,876</div>
                    <div class="indicator">
                        <i class='bx bx-up-arrow-alt'></i>
                        <span class="text">A urcat de ieri</span>
                    </div>
                </div>
            ...
            <div class="box">
                <div class="right-side">
                    <div class="box-topic">Numarul pensiunilor</div>
            ...
            <div class="box">
                <div class="right-side">
                    <div class="box-topic">Numarul localitatilor</div>
            ...
            <div class="box">
                <div class="right-side">
                    <div class="box-topic">Numarul de activitati</div>
                    <div class="number">11,086</div>
                    <div class="indicator">
                        <i class='bx bx-down-arrow-alt down'></i>
                        <span class="text">A scazut de ieri</span>
                    </div>
                </div>
        ...
        <div class="sales-boxes">
            <div class="recent-sales box">
                <div class="title">Lista turistilor inregistrati recenti</div>
